	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<div class="left">
					<ul>
						<li><i class="fa fa-phone"></i> <?php echo '011-62230100'; ?></li>
						<li><i class="fa fa-envelope-o"></i> <?php echo 'Swiftbuyyy@gmail.com'; ?></li>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row inner">
			...
			<div class="col-md-5 right">
				<ul>
					...
					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <?php echo LANG_VALUE_18; ?> (RM<?php
